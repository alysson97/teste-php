		...
		<ul class="nav navbar-nav pull-right">
			...
			<li class="dropdown" id="header_inbox_bar">
				...
				<ul class="dropdown-menu extended inbox">
					...
					<li class="external">
						<a href="inbox.php">Ver todas as mensagens <i class="m-icon-swapright"></i></a>
					</li>
				</ul>
			</li>
			<!-- END INBOX DROPDOWN -->
			...
			<li class="dropdown user">
				...
				<ul class="dropdown-menu">
					<li>
						<a href="extra_profile.php"><i class="fa fa-user"></i> Meu Perfil</a>
					</li>
					<li>
						<a href="page_calendar.php"><i class="fa fa-calendar"></i> Calendário</a>
					</li>
					<li>
						<a href="inbox.php"><i class="fa fa-envelope"></i> Mensagens
